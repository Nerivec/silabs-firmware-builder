...
DEFAULT_JSON_CONFIG = [
    # Fix a few paths by default
    {
        ...
        "jq": '(.package[] | select(.type == "zcl-properties")).path = "template:{sdk}/zigbee/app/zcl/zcl-zap.json"',
        "skip_if_missing": True,
    },
    {
        "file": "config/zcl/zcl_config.zap",
        "jq": '(.package[] | select(.type == "gen-templates-json")).path = "template:{sdk}/zigbee/app/framework/gen-template/gen-templates.json"',
        "skip_if_missing": True,
    },
]
