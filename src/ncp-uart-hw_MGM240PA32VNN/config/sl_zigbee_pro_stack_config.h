...
#define SL_ZIGBEE_MAX_END_DEVICE_CHILDREN   64
...
#define SL_ZIGBEE_APS_UNICAST_MESSAGE_COUNT   255
...
#define SL_ZIGBEE_APS_DUPLICATE_REJECTION_MAX_ENTRIES 255

// <o SL_ZIGBEE_BROADCAST_TABLE_SIZE> Broadcast Table Size <15-254>
// <i> Default: 15
// <i> The size of the broadcast table.
#define SL_ZIGBEE_BROADCAST_TABLE_SIZE   30
...
#define SL_ZIGBEE_NEIGHBOR_TABLE_SIZE   26
...
// <o SL_ZIGBEE_ADDRESS_TABLE_SIZE> Address table size <1-250>
// <i> Default: 2
// <i> The number of entries of the address table
#define SL_ZIGBEE_ADDRESS_TABLE_SIZE 250

// <o SL_ZIGBEE_ROUTE_TABLE_SIZE> Route table size <1-254>
// <i> Default: 16
// <i> The number of entries of the route table
#define SL_ZIGBEE_ROUTE_TABLE_SIZE 254

// <o SL_ZIGBEE_MULTICAST_TABLE_SIZE> Multicast table size <1-250>
// <i> Default: 8
// <i> The number of entries of the multicast table
#define SL_ZIGBEE_MULTICAST_TABLE_SIZE 26
